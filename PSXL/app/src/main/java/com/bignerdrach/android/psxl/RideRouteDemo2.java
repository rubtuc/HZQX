...
import com.bignerdrach.android.psxl.overlay.RideRouteOverlay;
import com.bignerdrach.android.psxl.util.AMapUtil;
import com.bignerdrach.android.psxl.util.ToastUtil;

public class RideRouteDemo2 extends AppCompatActivity implements AMap.OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ride_route_demo2);
    ...
    private void registerListener() {
        aMap.setOnMapClickListener(RideRouteDemo2.this);
        aMap.setOnMarkerClickListener(RideRouteDemo2.this);
        aMap.setOnInfoWindowClickListener(RideRouteDemo2.this);
        aMap.setInfoWindowAdapter(RideRouteDemo2.this);
